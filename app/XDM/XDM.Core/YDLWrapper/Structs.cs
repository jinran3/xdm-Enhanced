...
namespace YDLWrapper
{
    ...
    public struct YDLVideoEntry
    {
        ...
        public Dictionary<string, List<YDLSubtitle>> Subtitles { get; set; }
        [JsonProperty("automatic_captions")]
        public Dictionary<string, List<YDLSubtitle>> AutomaticCaptions { get; set; }
